...
export function restartTask(id) { return axios.post(`${BASE}/${id}/restart`) }
...
export function getCollectorLoginStatus() { return axios.get(`${BASE}/collector/login-status`) }
export function collectorLogin() { return axios.post(`${BASE}/collector/login`, {}, { timeout: 260000 }) }
